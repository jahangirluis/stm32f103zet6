...
struct rcvr_object;
typedef os_err_t (*rcvr_prot_par)(char *data, void *pos_data, os_uint16_t length);
typedef os_err_t (*rcvr_prot_cd)(struct rcvr_object* rcvr, void* pos_data);
typedef struct {
    void         *pos_data;
    rcvr_prot_par parse_func; /* parse function */
    rcvr_prot_cd  prot_cb;    /* parse complete function */
}rcvr_prot_t;
