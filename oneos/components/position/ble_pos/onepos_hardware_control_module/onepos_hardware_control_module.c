    ...
    case BLE_GAP_EVENT_DISC:
        ...
        if (fields.name != NULL)
        {
            ...
            if (onepos_ble_name_filtrate(name, name_len))
            {
                ...
                lat_lon_data = (char *)(fields.mfg_data) + 1;
                lat_lon_data_len = fields.mfg_data_len == 1 ? 0 : (fields.mfg_data_len - 1);
                onepos_adv_data_analysis(lat_lon_data, lat_lon_data_len, &lat, &lon); 
