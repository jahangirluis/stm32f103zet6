...
typedef char net_pos_pub_tpc_t[ONEPOS_MQTT_TOPIC_STRLEN];
...
#define DEF_NET_POS_INIT(pos_result) {pos_result, OS_NULL, OS_NULL, OS_NULL, OS_NULL, OS_NULL,                   \
						OS_NULL, OS_FALSE, OS_NULL, 0, NET_POS_DEF_INTERVAL, ONEPOS_CLOSING, (onepos_serv_type_t)NET_POS_DEF_SEV_TYPE}
