...
#define VFS_WORKDIR_LOCK_INIT()     os_mutex_init(&vfs_cwd_lock, "vfscwdlock", OS_FALSE)
#define VFS_WORKDIR_LOCK()          os_mutex_lock(&vfs_cwd_lock, OS_WAIT_FOREVER)
#define VFS_WORKDIR_UNLOCK()        os_mutex_unlock(&vfs_cwd_lock)
